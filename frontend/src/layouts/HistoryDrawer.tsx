 ...
 * 将 HistorySidebar 的内容包装在 Sheet 组件中
 */
...
export function HistoryDrawer({ open, onOpenChange, onSelectThread }: HistoryDrawerProps) {
  const {
    historyList,
    currentChatId,
    refreshHistoryList,
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="left" className="w-80 sm:w-80 p-0 flex flex-col">
